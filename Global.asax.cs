...
namespace ADA
{
    public class Global : System.Web.HttpApplication
    {
        ...
        private void Bootstrapper_Initialized(object sender, Telerik.Sitefinity.Data.ExecutedEventArgs e)
        {
            ...
            {
                Config.RegisterSection<ADAConfig>();
                EventHub.Subscribe<IMediaContentDownloadedEvent>(evt => Lino(evt));
            }
        }

        private void Lino(IMediaContentDownloadedEvent evt)
        {
